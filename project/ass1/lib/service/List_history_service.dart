...
class List_History extends StatefulWidget {
  ...
  final String role;
  const List_History({super.key, required this.nametecher, required this.role});
          ...
          if (widget.role == 'Teacher') ...[
            ...
            StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance
                  .collection('history')
                  .where('Teacher', isEqualTo: widget.nametecher)
            ...
            StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance
                  .collection('history')
                  .where('Student', isEqualTo: widget.nametecher)
                  .snapshots(), // get data in sql
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  final now = DateTime.now().toLocal();
